...
function bootstrapBasicEnqueueScripts() 
{
	...
	wp_enqueue_style('bootstrap-custom-style', get_template_directory_uri() . '/css/custom.css');
	...
	wp_enqueue_script('newsticker', get_template_directory_uri() . '/js/jquery.newsTicker.js');
...
/**
 * --------------------------------------------------------------
 * Adding a search form to the menu
 * --------------------------------------------------------------
 */
...
//        return $items."<li id='msearch' style='list-style-type:none'>

//    <form id='msearch' method='get' action='http://sb7.banyanstudio.net/'>
 //     <div>
